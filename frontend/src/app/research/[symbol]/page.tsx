...
*Disclaimer: Prepared by autonomous multi-agent analysis engines. Real-time parameters fluctuate. Past output yields do not guarantee positive capital gains.*
  ...
  if (isLoadingResearch) {
    return (
      <DashboardLayout>
        <div className="min-h-[600px] flex items-center justify-center bg-[#F8FAFC]">
          <div className="flex flex-col items-center gap-4 animate-pulse">
            <div className="w-16 h-16 rounded-2xl bg-[#2563EB] border-4 border-black shadow-[5px_5px_0px_#000000] animate-bounce flex items-center justify-center font-black text-white text-xl">
              SO
            </div>
            <span className="font-mono text-xs uppercase tracking-widest text-[#64748B] font-extrabold">
              Auditing Securities Matrix for {symbol}...
            </span>
          </div>
        </div>
      </DashboardLayout>
          ...
          <div className="lg:col-span-8 flex flex-col gap-8">
            ...
            <section className="bg-white border-4 border-black rounded-[24px] p-6 shadow-[4px_4px_0px_#000000]">
              ...
              {filteredHistory.length === 0 ? (
                <div className="h-64 flex items-center justify-center text-xs font-mono text-black/30 uppercase">
                  No price history points retrieved.
                </div>
              ) : (
              ...
              <div className="bg-white border-4 border-black p-5 rounded-[24px] shadow-[4px_4px_0px_#000000] flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-3.5 max-h-[300px] overflow-y-auto pr-1">
                  {researchData.agent_timeline && researchData.agent_timeline.length > 0 ? (
                    researchData.agent_timeline.map((msg, idx) => (
